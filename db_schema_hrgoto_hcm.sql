-- HRGoTo HCM comprehensive schema
-- Compatibility-focused: aligns with current controllers/models
...
VALUES
(1, 'HRGoTo Administrator', 'hradmin', 'hradmin@hrgoto.local', '$2y$11$eHBbsQ7mAbaTXMyBoDO4PuDU87TQDjUgzCbIccox2tgXcE.Dh2U9O', 1, 'Active')
ON DUPLICATE KEY UPDATE
